			...
			<div id="container">
				...
				<div id="outline">
					...
					<form id="info">
						...
						<div class="btn-group">
						 	<button type="button" id="department-category" class="btn btn-danger">Department</button>
						 	<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
						  	<ul class="dropdown-menu" role="menu">
						    	<li id="ART"><a>ART</a></li>
						    	<li id="DSGN"><a>DSGN</a></li>
						    	<li id="EECS"><a>EECS</a></li>
						    	<li id="GEN_MUS"><a>GEN_MUS</a></li>
						    	<li id="MUSICOL"><a>MUSICOL</a></li>
						    	<li id="PHYS"><a>PHYS</a></li>
						  	</ul>
						</div>
						<div class="btn-group">
						 	<button type="button" id="course-number"class="btn btn-danger">Course Number</button>
						 	<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><span class="caret"></span><span class="sr-only">Toggle Dropdown</span></button>
						  	<ul class="dropdown-menu" role="menu">
						    	<li id="101"><a>101</a></li>
						    	<li id="111"><a>111</a></li>
						    	<li id="211"><a>211</a></li>
						    	<li id="212"><a>212</a></li>
						    	<li id="213"><a>213</a></li>
						    	<li id="214"><a>214</a></li>
						  	</ul>
						</div><br>
